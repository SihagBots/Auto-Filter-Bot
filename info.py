...
# Bot information
API_ID = environ.get('API_ID', '29346781')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', '75fb004873db1864a09c71cd1307bfa8') #api hash of your telegram id
if len(API_HASH) == 0:
    print('Error - API_HASH is missing, exiting now')
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '8149320630:AAFRFE8wQIc3UCzyy_W8jr2_0bxP9vdI19w') #bot token from botfather
if len(BOT_TOKEN) == 0:
...
# Bot pics
PICS = (environ.get('PICS', 'https://envs.sh/_aY.jpg https://envs.sh/_aC.jpg https://envs.sh/_a1.jpg https://envs.sh/bkf.jpg')).split()

# Bot Admins
ADMINS = environ.get('ADMINS', '5860332990') #apni tg id daalo
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002367369414').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1001959367903').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002386658352') #bot log channel -1005293546253
...
SHORTLINK_API = environ.get("SHORTLINK_API", "c9db82e92c5ac629a3690636f1f73240742a6aa5")
...
URL = environ.get("URL", "https://web-0urqpajlcch8.up-de-fra1-k8s-1.apps.run-on-seenode.com/") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
